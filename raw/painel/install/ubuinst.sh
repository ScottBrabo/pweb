...
wget https://github.com/ScottBrabo/pweb/blob/main/raw/painel/install/pweb > /dev/null 2>&1
chmod 777 pweb > /dev/null 2>&1
clear
[[ ! -d /bin/ppweb ]] && mkdir /bin/ppweb
cd /bin/ppweb || exit
rm *.sh ver* > /dev/null 2>&1
wget https://github.com/ScottBrabo/pweb/blob/main/raw/painel/install/verifatt.sh > /dev/null 2>&1
wget https://github.com/ScottBrabo/pweb/blob/main/raw/painel/install/verpweb > /dev/null 2>&1
wget https://github.com/ScottBrabo/pweb/blob/main/raw/painel/install/verweb > /dev/null 2>&1
...
wget https://github.com/ScottBrabo/pweb/blob/main/raw/painel/install/gestorssh.zip > /dev/null 2>&1
...
key=$(curl -sSL "https://raw.githubusercontent.com/ScottBrabo/pweb/main/raw/painel/install/chave") &>/dev/null
               echo -e "[*] VALIDANDO A CHAVE DE INSTALAÇÃO"
                sleep 2
                echo "$(curl -sSL "https://raw.githubusercontent.com/ScottBrabo/pweb/main/raw/painel/install/chave")" > /bin/chave_inst
                echo -e "[*] CHAVE ACEITA"
                sleep 2
install_continue
install_continue2
